...
import { Modal, message, Spin, Tag, Input, Form, Button, Pagination, Empty } from 'antd';
...
import type { BaseResponse_Page_QuestionSetVO_ } from '../../../../generated/models/BaseResponse_Page_QuestionSetVO_';
  ...
  {loading ? (
    ...
    <div key={qs.id} className="qs-card">
      ...
      <button
        ...
        onClick={() => setDeleteConfirmOpen(qs.id)}
      >
        删除
      </button>
          </div>

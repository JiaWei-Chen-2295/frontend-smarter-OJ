...
export class QuestionControllerService {
    ...
    public static listQuestionSubmitByPageUsingPost(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/submit/admin/page',
    ...
    public static getQuestionListUsingPost(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/list/admin-page',
    ...
    public static getAllQuestionSubmitByListUsingGet(): CancelablePromise<BaseResponse_List_QuestionSubmit_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/question/submit/admin/list',
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
    ...
    public static getSubmitUsingGet(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/question/submit/getSubmitStatus',
            query: {
                'submitId': submitId,
            },
            errors: {
